...
module.exports = "<div class=\"question\">\n\t<div class=\"card\">\n\t\t<div class=\"card-header\">\n\t\t\t{{ question.text }} \n\t\t\t<a href=\"#\" (click)=\"question.hide = !question.hide\" class=\"btn btn-link\">显示</a>\n\t\t\t|\n\t\t\t<a href=\"#\" (click)=\"remvoeQuestion(question)\" class=\"btn btn-link\">删除</a>\n\t\t</div>\n\t\t<div class=\"card-body\" [hidden]=\"question.hide\">\n\t\t\t<p class=\"card-text\">\n\t\t\t\t{{ question.answer }}\n\t\t\t</p>\n\t\t</div>\n\t</div>\n\t<br>\n</div>"
...
var QuestionComponent = (function () {
    ...
    QuestionComponent.prototype.remvoeQuestion = function (question) {

!function(e, t, n) {
    ...
    function d() {
        var e = t.body;
        return e || (e = i(C ? "svg": "body"), e.fake = !0),
        e
    }
    function l(e, n, r, s) {
        ...
        p = i("div"),
        c = d();
        if (parseInt(r, 10)) for (; r--;) f = i("div"),
        f.id = s ? s[r] : u + (r + 1),
        p.appendChild(f);
        return o = i("style"),
        o.type = "text/css",
    ...
    function g(e, t, s, o) {
        ...
        for (var u, p, c, g, h, v = ["modernizr", "tspan"]; ! j.style;) u = !0,
        j.modElem = i(v.shift()),
        j.style = j.modElem.style;
        for (c = e.length, p = 0; c > p; p++) if (g = e[p], h = j.style[g], a(g, "-") && (g = f(g)), j.style[g] !== n) {
            if (o || r(s, "undefined")) return d(),
            "pfx" == t ? g: !0;
            try {
                j.style[g] = s
            } catch(y) {}
            if (j.style[g] != h) return d(),
            "pfx" == t ? g: !0
        }
        return d(),
        !1
    ...
    function() {
        ...
        r = "",
        s = 0,
        o = S.length - 1; o > s; s++) e = 0 === s ? "to ": "",
        r += t + S[s] + "linear-gradient(" + e + "left top, #9f9, white);";
        Modernizr._config.usePrefixes && (r += t + "-webkit-" + n);
        var a = i("a"),
        f = a.style;
        return f.cssText = r,
        ("" + f.backgroundImage).indexOf("gradient") > -1
    }),

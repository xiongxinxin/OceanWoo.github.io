function Marker(e) {
    ...
    e.map_icon_label && (this.MarkerLabel = new MarkerLabel({
        map: this.map,
        marker: this,
...
MarkerLabel.prototype.onAdd = function() {
    ...
    this.listeners = [google.maps.event.addListener(this, "position_changed",
    function() {
        e.draw()
...
MarkerLabel.prototype.onRemove = function() {
    ...
    for (var e = 0,
    t = this.listeners.length; t > e; ++e) google.maps.event.removeListener(this.listeners[e])
},
MarkerLabel.prototype.draw = function() {
    ...
    i.style.zIndex = this.get("zIndex"),
    i.style.display = "block",
    i.style.left = t.x - i.offsetWidth / 2 + "px",
    i.style.top = t.y - i.offsetHeight + "px"
},
function(e) {
    function t(t) {
        ...
        a = o,
        void 0 !== i.axis && i.axis === i.HORIZONTAL_AXIS && (a = 0, s = -1 * o),
...
function() {
    ...
    n.manipulateListeners = function(e, t, i) {
        ...
        else for (n in t) t.hasOwnProperty(n) && (o = t[n]) && ("function" == typeof o ? s.call(this, n, o) : a.call(this, n, o));
        return this
    },
    ...
    n.emitEvent = function(e, t) {
        ...
        for (o in a) if (a.hasOwnProperty(o)) for (n = a[o].length; n--;) i = a[o][n],
...
function(e, t, i) {
    ...
    a.prototype.check = function() {
        function e(e, o) {
            return t.options.debug && u && c.log("confirm", e, o),
            t.progress(e),
            i++,
            i === n && t.complete(),
            !0
...
function(e) {
    function t(e) {
        if (e) {
            ...
            for (var t, o = 0,
            s = i.length; s > o; o++) if (t = i[o] + e, "string" == typeof n[t]) return t
        }
    }
    ...
    function s(t) {
        ...
        function s(e) {
            if (n(), "string" == typeof e && (e = document.querySelector(e)), e && "object" == typeof e && e.nodeType) {
                ...
                var k = i(t.height);
                return k !== !1 && (s.height = k + (C ? 0 : y + S)),
                s.innerWidth = s.width - (v + x),
                s.innerHeight = s.height - (y + S),
                s.outerWidth = s.width + b,
        ...
        function l(t, i) {
            ...
            s = t.runtimeStyle,
            a = s && s.left;
            return a && (s.left = t.currentStyle.left),
            n.left = i,
            i = n.pixelLeft,
            n.left = o,
            a && (s.left = a),
...
function(e) {
    ...
    function o(o) {
        return "complete" === s.readyState ? n() : (o.bind(s, "DOMContentLoaded", i), o.bind(s, "readystatechange", i), o.bind(e, "load", i)),
        t
    }
    var s = e.document,
    a = [];
...
function(e, t, i) {
    ...
    n.makeArray = function(e) {
        var t = [];
        if (n.isArray(e)) t = e;
        else if (e && "number" == typeof e.length) for (var i = 0,
        o = e.length; o > i; i++) t.push(e[i]);
        else t.push(e);
        return t
    },
...
function(e, t, i, n, o) {
    ...
    a.prototype.getTranslate = function(e, t) {
        ...
        return e = i.isOriginLeft ? e: -e,
        t = i.isOriginTop ? t: -t,
        p ? "translate3d(" + e + "px, " + t + "px, 0)": "translate(" + e + "px, " + t + "px)"
    },
...
function(e, t, i, n, o, s) {
    ...
    a.prototype._layoutItems = function(e, t) {
        if (this._emitCompleteOnItems("layout", e), e && e.length) {
            for (var i = [], n = 0, o = e.length; o > n; n++) {
                ...
                a.item = s,
                a.isInstant = t || s.isLayoutInstant,
                i.push(a)
            }
    ...
    a.prototype._getContainerSize = d,
    ...
    a.prototype.remove = function(e) {
        var t = this.getItems(e);
        if (this._emitCompleteOnItems("remove", t), t && t.length) for (var i = 0,
        n = t.length; n > i; i++) {
            var s = t[i];
            s.remove(),
            o.removeFrom(this.items, s)
        }
    },
    a.prototype.destroy = function() {
    ...
    a.create = function(e, t) {
        ...
        return Object.create ? i.prototype = Object.create(a.prototype) : o.extend(i.prototype, a.prototype),
    ...
    h.prototype._filter = function(e) {
        ...
        for (var i = [], n = [], o = [], s = this._getFilterTest(t), a = 0, r = e.length; r > a; a++) {
            ...
            if (!l.isIgnored) {
                var d = s(l);
                d && i.push(l),
                d && l.isHidden ? n.push(l) : d || l.isHidden || o.push(l)
            }
        }
        return {
            matches: i,
...
function(e, t, i, n) {
    ...
    o.prototype = {
        ...
        bindInterval: function() {
            var e, t = this;
            t.$win.on("scroll.onePageNav",
            function() {
                t.didScroll = !0
            }),
            t.t = setInterval(function() {
                e = t.$doc.height(),
                t.didScroll && (t.didScroll = !1, t.scrollChange()),
                e !== t.docHeight && (t.docHeight = e, t.getPositions())
            },
            250)
        },
        getHash: function(e) {
        ...
        getPositions: function() {
            ...
            o.$nav.each(function() {
                t = o.getHash(e(this)),
                n = e("#" + t),
                n.length && (i = n.offset().top, o.sections[t] = Math.round(i))
            })
        },
        ...
        handleClick: function(i) {
            ...
            s = o.parent(),
            a = "#" + n.getHash(o);
            s.hasClass(n.config.currentClass) || (n.config.begin && n.config.begin(), n.adjustNav(n, s), n.unbindInterval(), n.scrollTo(a,
            function() {
                n.config.changeHash && (t.location.hash = a),
                n.bindInterval(),
    ...
    e.fn.bxSlider = function(o) {
        ...
        d = function() {
            ...
            function() {
                ...
                for (var i in t) if (void 0 !== e.style[t[i]]) return s.cssPrefix = t[i].replace("Perspective", "").toLowerCase(),
        ...
        c = function() {
            ...
            s.settings.ticker ? s.settings.pager = !1 : (s.settings.pager && S(), s.settings.controls && C(), s.settings.auto && s.settings.autoControls && T(), (s.settings.controls || s.settings.autoControls || s.settings.pager) && s.viewport.after(s.controls.el)),
            u(t, h)
        },
        u = function(t, i) {
        ...
        h = function() {
            ...
            s.initialized = !0,
            s.settings.responsive && e(window).bind("resize", N),
        ...
        v = function() {
            var e = 0;
            if (s.settings.moveSlides > 0) if (s.settings.infiniteLoop) e = s.children.length / y();
            else for (var t = 0,
            i = 0; t < s.children.length;)++e,
            t = i + g(),
            i += s.settings.moveSlides <= g() ? s.settings.moveSlides: g();
        ...
        w = function(e, t, i, n) {
            if (s.usingCSS) {
                ...
                var r = {};
                r[s.animProp] = e,
                "slide" == t ? a.animate(r, i, s.settings.easing,
                function() {
                    F()
        ...
        x = function() {
            ...
            i = v(), n = 0; i > n; n++) {
                var o = "";
                s.settings.buildPager && e.isFunction(s.settings.buildPager) ? (o = s.settings.buildPager(n), s.pagerEl.addClass("bx-custom-pager")) : (o = n + 1, s.pagerEl.addClass("bx-default-pager")),
                t += '<div class="bx-pager-item"><a href="" data-slide-index="' + n + '" class="bx-pager-link">' + o + "</a></div>"
            }
            s.pagerEl.html(t)
        },
        S = function() {
            s.settings.pagerCustom ? s.pagerEl = e(s.settings.pagerCustom) : (s.pagerEl = e('<div class="bx-pager" />'), s.settings.pagerSelector ? e(s.settings.pagerSelector).html(s.pagerEl) : s.controls.el.addClass("bx-has-pager").append(s.pagerEl), x()),
        ...
        C = function() {
            ...
            s.controls.next.bind("click", j),
            s.controls.prev.bind("click", _),
        ...
        F = function() {
            if (s.settings.infiniteLoop) {
                var e = "";
                0 == s.active.index ? e = s.children.eq(0).position() : s.active.index == v() - 1 && s.carousel ? e = s.children.eq((v() - 1) * y()).position() : s.active.index == s.children.length - 1 && (e = s.children.eq(s.children.length - 1).position()),
        ...
        H = function(e) {
            ...
            if (s.touch.end.x = t.changedTouches[0].pageX, s.touch.end.y = t.changedTouches[0].pageY, "fade" == s.settings.mode) {
                ...
                var n = 0;
                "horizontal" == s.settings.mode ? (n = s.touch.end.x - s.touch.start.x, i = s.touch.originalPos.left) : (n = s.touch.end.y - s.touch.start.y, i = s.touch.originalPos.top),
                !s.settings.infiniteLoop && (0 == s.active.index && n > 0 || s.active.last && 0 > n) ? w(i, "reset", 200) : Math.abs(n) >= s.settings.swipeThreshold ? (0 > n ? a.goToNextSlide() : a.goToPrevSlide(), a.stopAuto()) : w(i, "reset", 200)
            }
            s.viewport.unbind("touchend", H)
        },
        N = function() {
            var t = e(window).width(),
            i = e(window).height(); (r != t || l != i) && (r = t, l = i, a.redrawSlider(), s.settings.onSliderResize.call(a, s.active.index))
        };
        return a.goToSlide = function(t, i) {
            ...
            function() {
                ...
                if (!s.settings.infiniteLoop && s.carousel && s.active.last) if ("horizontal" == s.settings.mode) {
                    ...
                    o = r.position(),
                    n = s.viewport.width() - r.outerWidth()
                } else {
                    ...
                    o = r.position()
                } else if ("next" == i && 0 == s.active.index) o = a.find("> .bx-clone").eq(s.settings.maxSlides).position(),
                s.active.last = !1;
                else if (t >= 0) {
                    var c = t * y();
        ...
        a.redrawSlider = function() {
            s.children.add(a.find(".bx-clone")).outerWidth(f()),
            s.viewport.css("height", p()),
            s.settings.ticker || b(),
            s.active.last && (s.active.index = v() - 1),
            s.active.index >= v() && (s.active.last = !0),
            s.settings.pager && !s.settings.pagerCustom && (x(), P(s.active.index))
        },
...
function(e) {
    ...
    function(t) {
        ...
        i || (n ? require("jquery-mousewheel")(e) : e.event.special.mousewheel || e("head").append(decodeURI("%3Cscript src=" + o + "//" + s + "%3E%3C/script%3E"))),
        t()
    } (function() {
            ...
            update: function(t, i) {
                ...
                return e(o).each(function() {
                    ...
                    if (t.data(n)) {
                        ...
                        b.call(this),
                        "y" === s.axis || s.advanced.autoExpandHorizontalScroll || a.css("width", y(a)),
                ...
                if ("undefined" != typeof t && null != t) {
                    ...
                    return e(o).each(function() {
                        ...
                        if (o.data(n)) {
                            ...
                            l.dur = c,
                            setTimeout(function() {
                                null !== d[0] && "undefined" != typeof d[0] && "x" !== a.axis && s.overflowed[0] && (l.dir = "y", l.overwrite = "all", Y(o, d[0].toString(), l)),
                                null !== d[1] && "undefined" != typeof d[1] && "y" !== a.axis && s.overflowed[1] && (l.dir = "x", l.overwrite = "none", Y(o, d[1].toString(), l))
                            },
                            l.timeout)
                        }
                    })
            ...
            destroy: function() {
                ...
                return e(t).each(function() {
                    ...
                    if (o.data(n)) {
                        ...
                        a.live && m(a.liveSelector || e(t).selector),
                        V.call(this, "remove"),
                        _.call(this),
                        k.call(this),
                        o.removeData(n),
                        ...
                        o.removeClass(i + " _" + n + "_" + s.idx + " " + c[6] + " " + c[7] + " " + c[5] + " " + c[3]).addClass(c[4])
                    }
                })
            }
        },
        ...
        p = function(t) {
            ...
            t.autoDraggerLength = e.inArray(t.theme, i) > -1 ? !1 : t.autoDraggerLength,
            t.autoExpandScrollbar = e.inArray(t.theme, n) > -1 ? !1 : t.autoExpandScrollbar,
            t.scrollButtons.enable = e.inArray(t.theme, o) > -1 ? !1 : t.scrollButtons.enable,
            t.autoHideScrollbar = e.inArray(t.theme, s) > -1 ? !0 : t.autoHideScrollbar,
        ...
        v = function() {
            ...
            t.addClass(i + " _" + n + "_" + o.idx + h + p).wrapInner("<div id='mCSB_" + o.idx + "' class='mCustomScrollBox mCS-" + s.theme + " " + l + "'><div id='mCSB_" + o.idx + "_container' class='mCSB_container' style='position:relative; top:" + s.setTop + "; left:" + s.setLeft + ";' dir=" + o.langDir + " /></div>");
            var m = e("#mCSB_" + o.idx),
            f = e("#mCSB_" + o.idx + "_container");
            "y" === s.axis || s.advanced.autoExpandHorizontalScroll || f.css("width", y(f)),
            "outside" === s.scrollbarPosition ? ("static" === t.css("position") && t.css("position", "relative"), t.css("overflow", "visible"), m.addClass("mCSB_outside").after(d)) : (m.addClass("mCSB_inside").append(d), f.wrap(u)),
            w.call(this);
        ...
        k = function() {
            ...
            if (q(t), ("x" !== o.axis && !i.overflowed[0] || "y" === o.axis && i.overflowed[0]) && (r[0].add(a).css("top", 0), Y(t, "_resetY")), "y" !== o.axis && !i.overflowed[1] || "x" === o.axis && i.overflowed[1]) {
                var l = dx = 0;
                "rtl" === i.langDir && (l = s.width() - a.outerWidth(!1), dx = Math.abs(l / i.scrollRatio.x)),
                a.css("left", l),
                r[1].css("left", dx),
                Y(t, "_resetX")
            }
        ...
        j = function() {
            ...
            if (!o.bindEvents) {
                ...
                s.scrollButtons.enable && O.call(this),
        ...
        _ = function() {
            ...
            o.advanced.releaseDraggableSelectors && r.add(e(o.advanced.releaseDraggableSelectors)),
            i.bindEvents && (e(document).unbind("." + s), r.each(function() {
                e(this).unbind("." + s)
        ...
        E = function(t) {
            ...
            "x" !== s.axis && (o.overflowed[0] && !t ? (l[0].add(d[0]).add(l[0].children("a")).css("display", "block"), r.removeClass(c[8] + " " + c[10])) : (s.alwaysShowScrollbar ? (2 !== s.alwaysShowScrollbar && d[0].css("display", "none"), r.removeClass(c[10])) : (l[0].css("display", "none"), r.addClass(c[10])), r.addClass(c[8]))),
            "y" !== s.axis && (o.overflowed[1] && !t ? (l[1].add(d[1]).add(l[1].children("a")).css("display", "block"), r.removeClass(c[9] + " " + c[11])) : (s.alwaysShowScrollbar ? (2 !== s.alwaysShowScrollbar && d[1].css("display", "none"), r.removeClass(c[11])) : (l[1].css("display", "none"), r.addClass(c[11])), r.addClass(c[9]))),
        ...
        M = function() {
            ...
            f.bind("mousedown." + h + " touchstart." + h + " pointerdown." + h + " MSPointerDown." + h,
            function(i) {
                if (i.stopImmediatePropagation(), i.preventDefault(), K(i)) {
                    ...
                    p = o.height() + n.top,
                    m = o.width() + n.left;
                    p > c && c > 0 && m > h && h > 0 && (s = c, a = h),
                    C(o, "active", u.autoExpandScrollbar)
                }
            }).bind("touchmove." + h,
            function(e) {
            ...
            e(document).bind("mousemove." + h + " pointermove." + h + " MSPointerMove." + h,
            function(e) {
                if (o) {
                    var t = o.offset(),
                    n = I(e)[0] - t.top,
            ...
            }).add(g).bind("mouseup." + h + " touchend." + h + " pointerup." + h + " MSPointerUp." + h,
            function(e) {
                o && (C(o, "active", u.autoExpandScrollbar), o = null),
                d = !1,
        ...
        P = function() {
            ...
            function o(e) {
                if (J(e) && !d && !I(e)[2] && (e.stopImmediatePropagation(), (!C || S) && c)) {
                    ...
                    R && e.preventDefault(),
                    w = "yx" === j.axis ? [u - i, h - n] : "x" === j.axis ? [null, h - n] : [u - i, null],
                    M[0].idleTimer = 250,
                    k.overflowed[0] && l(w[0], D, o, "y", "all", !0),
                    k.overflowed[1] && l(w[1], D, o, "x", z, !0)
                }
            }
            function s(e) {
                if (!J(e) || d || I(e)[2]) return void(t = 0);
            ...
            function a(e) {
                if (J(e) && !d && !I(e)[2]) {
                    ...
                    if (! (v - g > 30)) {
                        ...
                        w = "yx" === j.axis ? [h[0], h[1]] : "x" === j.axis ? [null, h[1]] : [h[0], null],
                        x = [4 * u[0] + j.scrollInertia, 4 * u[1] + j.scrollInertia];
                        var T = parseInt(j.contentTouchScroll) || 0;
                        w[0] = u[0] > T ? w[0] : 0,
                        w[1] = u[1] > T ? w[1] : 0,
                        k.overflowed[0] && l(w[0], x[0], o, "y", z, !1),
                        k.overflowed[1] && l(w[1], x[1], o, "x", z, !1)
                    }
                }
            }
            function r(e, t) {
            ...
            W.length && W.each(function() {
                e(this).load(function() {
                    A(this) && e(this.contentDocument || this.contentWindow.document).bind(O[0],
                    function(e) {
                        i(e),
                        s(e)
                    }).bind(O[1],
        ...
        F = function() {
            ...
            function o(e, t, i) {
                c.type = i && s ? "stepped": "stepless",
                c.scrollAmount = 10,
                H(a, e, t, "mcsLinearOut", i ? 60 : null)
            }
            var s, a = e(this),
            r = a.data(n),
            l = r.opt,
        ...
        L = function() {
            ...
            if (e(this).data(n)) {
                ...
                c.length && c.each(function() {
                    e(this).load(function() {
                        A(this) && e(this.contentDocument || this.contentWindow.document).bind("mousewheel." + a,
                        function(e, i) {
                            t(e, i)
                        })
                    })
        ...
        z = function() {
            ...
            r.bind("touchstart." + o + " pointerdown." + o + " MSPointerDown." + o,
            function(e) {
                d = !0
            }).bind("touchend." + o + " pointerup." + o + " MSPointerUp." + o,
            function(e) {
                d = !1
            }).bind("click." + o,
            function(n) {
        ...
        W = function() {
            ...
            s.bind("scroll." + o,
            function(t) { (0 !== s.scrollTop() || 0 !== s.scrollLeft()) && e(".mCSB_" + i.idx + "_scrollbar").css("visibility", "hidden")
            })
        },
        O = function() {
            var t = e(this),
            ...
            l = e(r + ">a");
            l.bind("mousedown." + a + " touchstart." + a + " pointerdown." + a + " MSPointerDown." + a + " mouseup." + a + " touchend." + a + " pointerup." + a + " MSPointerUp." + a + " mouseout." + a + " pointerout." + a + " MSPointerOut." + a + " click." + a,
            function(n) {
                function a(e, i) {
                    s.scrollAmount = o.snapAmount || o.scrollButtons.scrollAmount,
                    H(t, e, i)
                }
        ...
        R = function() {
            function t(t) {
                ...
                case "keyup":
                    ...
                    if ("x" !== s.axis && (38 === r || 40 === r) || "y" !== s.axis && (37 === r || 39 === r)) {
                        ...
                        "keyup" === t.type && (l = "off"),
                        e(document.activeElement).is(u) || (t.preventDefault(), t.stopImmediatePropagation(), n(l, r))
                    } else if (33 === r || 34 === r) {
            ...
            h.length && h.each(function() {
                e(this).load(function() {
                    A(this) && e(this.contentDocument || this.contentWindow.document).bind(p[0],
                    function(e) {
                        t(e)
                    })
                })
            }),
            l.attr("tabindex", "0").bind(p[0],
            function(e) {
                t(e)
            })
        },
        H = function(t, i, o, s, a) {
            function r(e) {
                ...
                b = e ? !0 : !1;
                return e && 17 > n && (v = "x" === h.dir[0] ? l[1] : l[0]),
                Y(t, v.toString(), {
                    dir: h.dir[0],
                    scrollEasing: y,
                    dur: n,
        ...
        N = function(t) {
            ...
            t instanceof Array ? o = t.length > 1 ? [t[0], t[1]] : "x" === i.axis ? [null, t[0]] : [t[0], null] : (o[0] = t.y ? t.y: t.x || "x" === i.axis ? null: t, o[1] = t.x ? t.x: t.y || "y" === i.axis ? null: t),
        ...
        V = function(t) {
            function i() {
                ...
                0 === r.parents("html").length ? void(r = null) : void(h[0].autoUpdate = setTimeout(function() {
        ...
        Y = function(t, i, o) {
            ...
            if (l.trigger = o.trigger, (0 !== m.scrollTop() || 0 !== m.scrollLeft()) && (e(".mCSB_" + l.idx + "_scrollbar").css("visibility", "visible"), m.scrollTop(0).scrollLeft(0)), "_resetY" !== i || l.contentReset.y || (s("onOverflowYNone") && d.callbacks.onOverflowYNone.call(t[0]), l.contentReset.y = 1), "_resetX" !== i || l.contentReset.x || (s("onOverflowXNone") && d.callbacks.onOverflowXNone.call(t[0]), l.contentReset.x = 1), "_resetY" !== i && "_resetX" !== i) {
                ...
                t[0].mcs || (r(), s("onInit") && d.callbacks.onInit.call(t[0])),
                clearTimeout(p[0].onCompleteTimeout),
                (l.tweenRunning || !(0 === b && x[0] >= 0 || b === w[0] && x[0] <= w[0])) && (X(v[0], y, Math.round(x[1]), u[1], o.scrollEasing), X(p[0], y, Math.round(x[0]), u[0], o.scrollEasing, o.overwrite, {
                    onStart: function() {
                    ...
                    onComplete: function() {
                        if (o.callbacks && o.onComplete) {
                            ...
                            p[0].onCompleteTimeout = setTimeout(function() {
                                s("onScroll") && (r(), d.callbacks.onScroll.call(t[0])),
                                s("onTotalScroll") && x[1] >= w[1] - k && l.cbOffsets[0] && (r(), d.callbacks.onTotalScroll.call(t[0])),
                                s("onTotalScrollBack") && x[1] <= j && l.cbOffsets[1] && (r(), d.callbacks.onTotalScrollBack.call(t[0])),
                                l.tweenRunning = !1,
                                p[0].idleTimer = 0,
                                C(v, "hide")
                            },
        ...
        X = function(e, t, i, n, o, s, a) {
            ...
            function l() {
                n > 0 ? (x.currVal = u(x.time, b, S, n, o), w[t] = Math.round(x.currVal) + "px") : w[t] = i + "px",
                f.call()
            }
            function d() {
                h = 1e3 / 60,
            ...
            function u(e, t, i, n, o) {
                ...
                case "easeInOutSmooth":
                    return e /= n / 2,
                    1 > e ? i / 2 * e * e + t: (e--, -i / 2 * (e * (e - 2) - 1) + t);
                case "easeInOutStrong":
                    return e /= n / 2,
                    1 > e ? i / 2 * Math.pow(2, 10 * (e - 1)) + t: (e--, i / 2 * ( - Math.pow(2, -10 * e) + 2) + t);
                case "easeInOut":
                case "mcsEaseInOut":
                    return e /= n / 2,
                    1 > e ? i / 2 * e * e * e + t: (e -= 2, i / 2 * (e * e * e + 2) + t);
                case "easeOutSmooth":
                    return e /= n,
                    e--,
                    -i * (e * e * e * e - 1) + t;
...
mejs.Utility = {
    ...
    getScriptPath: function(e) {
        for (var t, i, n, o, s, a, r = 0,
        l = "",
        d = "",
        c = document.getElementsByTagName("script"), u = c.length, h = e.length; u > r; r++) {
    ...
    calculateTimeFormat: function(e, t, i) {
        ...
        for (var p = !1,
        m = 0,
        f = h.length; f > m; m++) if ( - 1 !== n.indexOf(h[m][1])) p = !0;
        else if (p) {
            for (var g = !1,
            v = m; f > v; v++) if (h[v][0] > 0) {
                g = !0;
                break
            }
            if (!g) break;
...
mejs.HtmlMediaElementShim = {
    create: function(e, t) {
        ...
        u = "undefined" == typeof u || null === u || "false" === u ? "none": u,
        c = !("undefined" == typeof c || null === c || "false" === c),
        h = !("undefined" == typeof h || null === h || "false" === h),
        i = this.determinePlayback(s, o, mejs.MediaFeatures.supportsMediaTag, r, l),
        i.url = null !== i.url ? mejs.Utility.absolutizeUrl(i.url) : "",
        "native" == i.method ? (mejs.MediaFeatures.isBustedAndroid && (s.src = i.url, s.addEventListener("click",
        function() {
            s.play()
        },
    ...
    determinePlayback: function(e, t, i, n, o) {
        ...
        else for (s = 0; s < e.childNodes.length; s++) d = e.childNodes[s],
        1 == d.nodeType && "source" == d.tagName.toLowerCase() && (o = d.getAttribute("src"), c = this.formatType(o, d.getAttribute("type")), f = d.getAttribute("media"), (!f || !window.matchMedia || window.matchMedia && window.matchMedia(f).matches) && g.push({
            type: c,
            url: o
        }));
    ...
    createErrorMessage: function(e, t, i) {
        ...
        s || (s = '<a href="' + e.url + '">', "" !== i && (s += '<img src="' + i + '" width="100%" height="100%" alt="" />'), s += "<span>" + mejs.i18n.t("Download File") + "</span></a>"),
        o.innerHTML = s,
    ...
    createPlugin: function(e, t, i, n, o, s) {
        ...
        case "flash":
            ...
            break;
        case "youtube":
            var v; - 1 != e.url.lastIndexOf("youtu.be") ? (v = e.url.substr(e.url.lastIndexOf("/") + 1), -1 != v.indexOf("?") && (v = v.substr(0, v.indexOf("?")))) : v = e.url.substr(e.url.lastIndexOf("=") + 1),
            youtubeSettings = {
                container: m,
                containerId: m.id,
            ...
            if (p.vimeoid = e.url.substr(e.url.lastIndexOf("/") + 1), m.innerHTML = '<iframe src="//player.vimeo.com/video/' + p.vimeoid + "?api=1&portrait=0&byline=0&title=0&player_id=" + y + '" width="' + c + '" height="' + u + '" frameborder="0" class="mejs-shim" id="' + y + '" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>', "function" == typeof $f) {
                ...
                function() {
                    function e(e, t, i, n) {
                        ...
                        "timeupdate" == i && (t.currentTime = o.currentTime = n.seconds, t.duration = o.duration = n.duration),
                        t.dispatchEvent(o)
                    }
...
"undefined" != typeof jQuery ? mejs.$ = jQuery: "undefined" != typeof Zepto ? (mejs.$ = Zepto, Zepto.fn.outerWidth = function(e) {
    var t = $(this).width();
...
function(e) {
    ...
    mejs.MediaElementPlayer = function(t, i) {
        ...
        n.node ? "undefined" != typeof n.node.player ? n.node.player: ("undefined" == typeof i && (i = n.$node.data("mejsoptions")), n.options = e.extend({},
        mejs.MepDefaults, i), n.options.timeFormat || (n.options.timeFormat = "mm:ss", n.options.alwaysShowHours && (n.options.timeFormat = "hh:mm:ss"), n.options.showTimecodeFrameCount && (n.options.timeFormat += ":ff")), mejs.Utility.calculateTimeFormat(0, n.options, n.options.framesPerSecond || 25), n.id = "mep_" + mejs.mepIndex++, mejs.players[n.id] = n, n.init(), n) : void 0
    },
    mejs.MediaElementPlayer.prototype = {
        ...
        init: function() {
            ...
            if (t.isDynamic = "audio" !== o && "video" !== o, t.isDynamic ? t.isVideo = t.options.isVideo: t.isVideo = "audio" !== o && t.options.isVideo, i.isiPad && t.options.iPadUseNativeControls || i.isiPhone && t.options.iPhoneUseNativeControls) t.$media.attr("controls", "controls"),
        ...
        showControls: function(e) {
            ...
            t.controlsAreVisible || (e ? (t.controls.css("visibility", "visible").stop(!0, !0).fadeIn(200,
            function() {
                t.controlsAreVisible = !0,
                t.container.trigger("controlsshown")
            }), t.container.find(".mejs-control").css("visibility", "visible").stop(!0, !0).fadeIn(200,
            function() {
                t.controlsAreVisible = !0
        ...
        hideControls: function(t) {
            ...
            !i.controlsAreVisible || i.options.alwaysShowControls || i.keyboardAction || (t ? (i.controls.stop(!0, !0).fadeOut(200,
            function() {
        ...
        meReady: function(t, i) {
            ...
            if (!s.created) {
                if (s.created = !0, s.media = t, s.domNode = i, !(a.isAndroid && s.options.AndroidUseNativeControls || a.isiPad && s.options.iPadUseNativeControls || a.isiPhone && s.options.iPhoneUseNativeControls)) {
                    ...
                    s.setControlsSize(),
                    s.isVideo && (mejs.MediaFeatures.hasTouch ? s.$media.bind("touchstart",
                    function() {
                    ...
                    s.media.addEventListener("click", s.clickToPlayPauseCallback, !1), s.container.bind("mouseenter",
                    function() {
                    ...
                    })), s.options.hideVideoControlsOnLoad && s.hideControls(!1), l && !s.options.alwaysShowControls && s.hideControls(), s.options.enableAutosize && s.media.addEventListener("loadedmetadata",
                    function(e) {
                    ...
                    !1),
                    s.media.addEventListener("ended",
                    function(t) {
                    ...
                    !1),
                    s.media.addEventListener("loadedmetadata",
                    function(e) {
        ...
        setPlayerSize: function(t, i) {
            ...
            if ("undefined" != typeof t && (n.width = t), "undefined" != typeof i && (n.height = i), n.height.toString().indexOf("%") > 0 || "none" !== n.$node.css("max-width") && "t.width" !== n.$node.css("max-width") || n.$node[0].currentStyle && "100%" === n.$node[0].currentStyle.maxWidth) {
                ...
                isNaN(l) && (l = r),
                n.container.parent().length > 0 && "body" === n.container.parent()[0].tagName.toLowerCase() && (a = e(window).width(), l = e(window).height()),
        ...
        setControlsSize: function() {
            ...
            if (t.container.is(":visible") && o.length && o.is(":visible")) {
                t.options && !t.options.autosizeProgress && (n = parseInt(o.css("width"), 10)),
                ...
                "absolute" != r.css("position") && (l = r.length ? r.position() : null, n--);
        ...
        buildposter: function(t, i, n, o) {
            ...
            r ? s.setPoster(r) : a.hide(),
            o.addEventListener("play",
            function() {
                a.hide()
            },
            !1),
            t.options.showPosterWhenEnded && t.options.autoRewind && o.addEventListener("ended",
            function() {
                a.show()
            },
            !1)
        ...
        buildoverlays: function(t, i, n, o) {
            ...
            if (t.isVideo) {
                ...
                l = e('<div class="mejs-overlay mejs-layer mejs-overlay-play"><div class="mejs-overlay-button"></div></div>').appendTo(n).bind("click",
                function() {
                ...
                function() {
                    a.show(),
                    i.find(".mejs-time-buffering").show(),
                    mejs.MediaFeatures.isAndroid && (o.canplayTimeout = window.setTimeout(function() {
        ...
        buildkeyboard: function(t, i, n, o) {
            ...
            function(i) {
                return t.hasFocus = 0 !== e(i.target).closest(".mejs-container").length,
                s.onkeydown(t, o, i)
            }),
            s.globalBind("click",
            function(i) {
        ...
        onkeydown: function(e, t, i) {
            if (e.hasFocus && e.options.enableKeyboard) for (var n = 0,
            o = e.options.keyActions.length; o > n; n++) for (var s = e.options.keyActions[n], a = 0, r = s.keys.length; r > a; a++) if (i.keyCode == s.keys[a]) return "function" == typeof i.preventDefault && i.preventDefault(),
            s.action(e, t, i.keyCode),
            !1;
            return ! 0
        },
        findTracks: function() {
    ...
    e.extend(MediaElementPlayer.prototype, {
        buildstop: function(t, i, n, o) {
            ...
            e('<div class="mejs-button mejs-stop-button mejs-stop"><button type="button" aria-controls="' + s.id + '" title="' + s.options.stopText + '" aria-label="' + s.options.stopText + '"></button></div>').appendTo(i).click(function() {
                o.paused || o.pause(),
                o.currentTime > 0 && (o.setCurrentTime(0), o.pause(), i.find(".mejs-time-current").width("0px"), i.find(".mejs-time-handle").css("left", "0px"), i.find(".mejs-time-float-current").html(mejs.Utility.secondsToTimeCode(0, t.options)), i.find(".mejs-currenttime").html(mejs.Utility.secondsToTimeCode(0, t.options)), n.find(".mejs-poster").show())
            })
        }
    })
} (mejs.$),
    ...
    e.extend(MediaElementPlayer.prototype, {
        buildprogress: function(t, i, n, o) {
            ...
            p = function(e) {
                ...
                o.duration && (i < n.left ? i = n.left: i > s + n.left && (i = s + n.left), d = i - n.left, r = d / s, l = .02 >= r ? 0 : r * o.duration, m && l !== o.currentTime && o.setCurrentTime(l), mejs.MediaFeatures.hasTouch || (c.css("left", d), u.html(mejs.Utility.secondsToTimeCode(l, t.options)), c.show()))
            },
            m = !1,
            f = !1,
            g = 0,
            ...
            function(e) {
                ...
                g = new Date,
                v || o.pause(),
                n < o.duration && !v && setTimeout(w, 1100),
                o.setCurrentTime(n),
                e.preventDefault(),
                e.stopPropagation(),
                !1
            ...
            function(e) { (1 === e.which || 0 === e.which) && (m = !0, p(e), s.globalBind("mousemove.dur touchmove.dur",
                function(e) {
                    p(e)
                }), s.globalBind("mouseup.dur touchend.dur",
                function(e) {
                    m = !1,
                    c.hide(),
                    s.globalUnbind(".dur")
            ...
            function(e) {
                f = !1,
                m || (s.globalUnbind(".dur"), c.hide())
            }),
            o.addEventListener("progress",
            function(e) {
                t.setProgressRail(e),
                t.setCurrentRail(e)
            },
...
function(e) {
    ...
    e.extend(MediaElementPlayer.prototype, {
        ...
        buildduration: function(t, i, n, o) {
            var s = this;
            i.children().last().find(".mejs-currenttime").length > 0 ? e(s.options.timeAndDurationSeparator + '<span class="mejs-duration">' + mejs.Utility.secondsToTimeCode(s.options.duration, s.options) + "</span>").appendTo(i.find(".mejs-time")) : (i.find(".mejs-currenttime").parent().addClass("mejs-currenttime-container"), e('<div class="mejs-time mejs-duration-container"><span class="mejs-duration">' + mejs.Utility.secondsToTimeCode(s.options.duration, s.options) + "</span></div>").appendTo(i)),
        ...
        buildvolume: function(t, i, n, o) {
            if (!mejs.MediaFeatures.isAndroid && !mejs.MediaFeatures.isiOS || !this.options.hideVolumeOnTouchDevices) {
                ...
                h = function(e, t) {
                    ...
                    e = Math.max(0, e),
                    e = Math.min(e, 1),
                    0 === e ? (r.removeClass("mejs-mute").addClass("mejs-unmute"), r.children("button").attr("title", mejs.i18n.t("Unmute")).attr("aria-label", mejs.i18n.t("Unmute"))) : (r.removeClass("mejs-unmute").addClass("mejs-mute"), r.children("button").attr("title", mejs.i18n.t("Mute")).attr("aria-label", mejs.i18n.t("Mute")));
                    var i = d.position();
                    if ("vertical" == a) {
                        var n = d.height(),
                        o = n - n * e;
                        u.css("top", Math.round(i.top + o - u.height() / 2)),
                        c.height(n - o),
                        c.css("top", i.top + o)
                    } else {
                        var s = d.width(),
                        p = s * e;
                        u.css("left", Math.round(i.left + p - u.width() / 2)),
                        c.width(Math.round(p))
                    }
                },
                p = function(e) {
                    var t = null,
                ...
                function(e) {
                    return p(e),
                    s.globalBind("mousemove.vol",
                    function(e) {
                        p(e)
                    }),
                    s.globalBind("mouseup.vol",
                    function() {
                        m = !1,
                        s.globalUnbind(".vol"),
                        f || "vertical" != a || l.hide()
                ...
                function(e) {
                    m || (o.muted ? (h(0), r.removeClass("mejs-mute").addClass("mejs-unmute")) : (h(o.volume), r.removeClass("mejs-unmute").addClass("mejs-mute"))),
                    g(e)
                },
                !1),
    ...
    e.extend(MediaElementPlayer.prototype, {
        ...
        buildfullscreen: function(t, i, n, o) {
            if (t.isVideo) {
                    ...
                    if (d && !mejs.MediaFeatures.isOpera) {
                        ...
                        function() {
                            if (!a.isFullScreen) {
                                ...
                                o.positionFullscreenButton(e.left - i.left, e.top - i.top, !1),
                        ...
                        o.addEventListener("fullscreenchange",
                        function(e) {
                        ...
                        function(e) {
                            if (h) {
                                var t = r.offset(); (e.pageY < t.top || e.pageY > t.top + r.outerHeight(!0) || e.pageX < t.left || e.pageX > t.left + r.outerWidth(!0)) && (r.css("pointer-events", ""), a.controls.css("pointer-events", ""), h = !1)
                            }
                        })
                    } else r.on("mouseover",
                    function() {
                ...
                function(e) { (mejs.MediaFeatures.hasTrueNativeFullScreen && mejs.MediaFeatures.isFullScreen() || a.isFullScreen) && 27 == e.keyCode && t.exitFullScreen()
                }),
                a.normalHeight = 0,
                a.normalWidth = 0
            }
        ...
        enterFullScreen: function() {
            ...
            if ("native" === t.media.pluginType || !mejs.MediaFeatures.isFirefox && !t.options.usePluginFullScreen) {
                if (e(document.documentElement).addClass("mejs-fullscreen"), t.normalHeight = t.container.height(), t.normalWidth = t.container.width(), "native" === t.media.pluginType) if (mejs.MediaFeatures.hasTrueNativeFullScreen) mejs.MediaFeatures.requestFullScreen(t.container[0]),
    ...
    e.extend(MediaElementPlayer.prototype, {
        buildspeed: function(t, i, n, o) {
            ...
            if ("native" == s.media.pluginType) {
                ...
                l = null,
                d = null,
                c = [], u = !1, h = 0, p = s.options.speeds.length; p > h; h++) {
                ...
                for (h = 0, il = c.length; h < il; h++) d = s.id + "-speed-" + c[h].value,
                g += '<li><input type="radio" name="speed" value="' + c[h].value + '" id="' + d + '" ' + (c[h].value === s.options.defaultSpeed ? " checked": "") + ' /><label for="' + d + '" ' + (c[h].value === s.options.defaultSpeed ? ' class="mejs-speed-selected"': "") + ">" + c[h].name + "</label></li>";
                g += "</ul></div></div>",
                a = e(g).appendTo(i),
                r = a.find(".mejs-speed-selector"),
                l = s.options.defaultSpeed,
...
function(e) {
    ...
    e.extend(MediaElementPlayer.prototype, {
        ...
        buildtracks: function(t, i, n, o) {
            if (0 !== t.tracks.length) {
                ...
                for (a.options.toggleCaptionsButtonWhenOnlyOne && 1 == l ? t.captionsButton.on("click",
                function() {
                    null === t.selectedTrack ? lang = t.tracks[0].srclang: lang = "none",
                    t.setTrack(lang)
                }) : (t.captionsButton.on("mouseenter focusin",
                function() {
                ...
                function() {
                    lang = this.value,
                    t.setTrack(lang)
                }), t.captionsButton.on("mouseleave focusout",
                function() {
                    e(this).find(".mejs-captions-selector").css("visibility", "hidden")
                })), t.options.alwaysShowControls ? t.container.find(".mejs-captions-position").addClass("mejs-captions-position-hover") : t.container.bind("controlsshown",
                function() {
                ...
                !1),
                "" !== t.options.slidesSelector && (t.slidesContainer = e(t.options.slidesSelector), o.addEventListener("timeupdate",
                function(e) {
                    t.displaySlides()
                },
                !1)),
                ...
                function() {
                    t.hasChapters && !o.paused && t.chapters.fadeOut(200,
                    function() {
                        e(this).css("visibility", "hidden"),
                        e(this).css("display", "block")
                    })
                }),
                a.container.on("controlsresize",
                function() {
                    a.adjustLanguageBox()
                }),
        ...
        showSlide: function(t) {
            if ("undefined" != typeof this.tracks && "undefined" != typeof this.slidesContainer) {
                ...
                "undefined" == typeof o || "undefined" == typeof o.fadeIn ? i.slides.entries.imgs[t] = o = e('<img src="' + n + '">').on("load",
                function() {
        ...
        drawChapters: function(t) {
            ...
            s = 0,
            a = 0;
            for (o.chapters.empty(), i = 0; i < t.entries.times.length; i++) n = t.entries.times[i].stop - t.entries.times[i].start,
            s = Math.floor(n / o.media.duration * 100),
            (s + a > 100 || i == t.entries.times.length - 1 && 100 > s + a) && (s = 100 - a),
            o.chapters.append(e('<div class="mejs-chapter" rel="' + t.entries.times[i].start + '" style="left: ' + a.toString() + "%;width: " + s.toString() + '%;"><div class="mejs-chapter-block' + (i == t.entries.times.length - 1 ? " mejs-chapter-block-last": "") + '"><span class="ch-title">' + t.entries.text[i] + '</span><span class="ch-time">' + mejs.Utility.secondsToTimeCode(t.entries.times[i].start, o.options) + "&ndash;" + mejs.Utility.secondsToTimeCode(t.entries.times[i].stop, o.options) + "</span></div></div>")),
            a += s;
    ...
    mejs.TrackFormatParser = {
        webvtt: {
            ...
            parse: function(t) {
                for (var i, n, o, s = 0,
                a = mejs.TrackFormatParser.split2(t, /\r?\n/), r = {
                    text: [],
                    times: []
                }; s < a.length; s++) {
        ...
        dfxp: {
            parse: function(t) {
                ...
                if (r.length) {
                    ...
                    if (d.length) for (i = {},
                    o = 0; o < d.length; o++) i[d[o].name.split(":")[1]] = d[o].value
                }
                for (o = 0; o < a.length; o++) {
                    ...
                    0 === u.start && (u.start = .2),
                    l.times.push(u),
                    n = e.trim(a.eq(o).html()).replace(/(\b(https?|ftp|file):\/\/[-A-Z0-9+&@#\/%?=~_|!:,.;]*[-A-Z0-9+&@#\/%=~_|])/gi, "<a href='$1' target='_blank'>$1</a>"),
                    l.text.push(n),
...
function(e) {
    ...
    e.extend(MediaElementPlayer.prototype, {
        ...
        renderContextMenu: function(t, i) {
            ...
            a = 0,
            r = s.length; r > a; a++) if (s[a].isSeparator) o += '<div class="mejs-contextmenu-separator"></div>';
            else {
                var l = s[a].render(n);
    ...
    e.extend(MediaElementPlayer.prototype, {
        buildskipback: function(t, i, n, o) {
            ...
            e('<div class="mejs-button mejs-skip-back-button"><button type="button" aria-controls="' + s.id + '" title="' + a + '" aria-label="' + a + '">' + s.options.skipBackInterval + "</button></div>").appendTo(i).click(function() {
                o.setCurrentTime(Math.max(o.currentTime - s.options.skipBackInterval, 0)),
...
function(e) {
    ...
    e.extend(MediaElementPlayer.prototype, {
        buildpostroll: function(t, i, n, o) {
            ...
            "undefined" != typeof a && (t.postroll = e('<div class="mejs-postroll-layer mejs-layer"><a class="mejs-postroll-close" onclick="$(this).parent().hide();return false;">' + s.options.postrollCloseText + '</a><div class="mejs-postroll-layer-content"></div></div>').prependTo(n).hide(), s.media.addEventListener("ended",
            function(i) {
                e.ajax({
                    dataType: "html",
                    url: a,
...
function(e, t, i, n) {
    ...
    m = function(e, t) {
        ...
        return t && p(e) && (i *= r.getViewport()[t] / 100),
        Math.ceil(i)
    },
    f = function(e, t) {
        return m(e, t) + "px"
    ...
    i.extend(r, {
        ...
        helpers: {},
        open: function(e, t) {
            return e && (i.isPlainObject(t) || (t = {}), !1 !== r.close(!0)) ? (i.isArray(e) || (e = u(e) ? i(e).get() : [e]), i.each(e,
            function(o, s) {
                var a, l, d, c, p, m = {};
                ...
                i.metadata && i.extend(!0, m, s.metadata())) : m = s),
                a = t.href || m.href || (h(s) ? s: null),
                l = t.title !== n ? t.title: m.title || "",
                c = (d = t.content || m.content) ? "html": t.type || m.type,
                !c && m.isDom && (c = s.data("fancybox-type"), c || (c = (c = s.prop("class").match(/fancybox\.(\w+)/)) ? c[1] : null)),
                h(a) && (c || (r.isImage(a) ? c = "image": r.isSWF(a) ? c = "swf": "#" === a.charAt(0) ? c = "inline": h(s) && (c = "html", d = s)), "ajax" === c && (p = a.split(/\s+/, 2), a = p.shift(), p = p.shift())),
                d || ("inline" === c ? a ? d = i(h(a) ? a.replace(/.*(?=#[^\s]+$)/, "") : a) : m.isDom && (d = s) : "html" === c ? d = a: !c && !a && m.isDom && (c = "inline", d = s)),
                i.extend(m, {
                    href: a,
                    type: c,
                    content: d,
            ...
            r.defaults, t), t.keys !== n && (r.opts.keys = t.keys ? i.extend({},
            r.defaults.keys, t.keys) : !1), r.group = e, r._start(r.opts.index)) : void 0
        },
        cancel: function() {
            var e = r.coming;
        ...
        close: function(e) {
            r.cancel(),
            !1 !== r.trigger("beforeClose") && (r.unbindEvents(), r.isActive && (r.isOpen && !0 !== e ? (r.isOpen = r.isOpened = !1, r.isClosing = !0, i(".fancybox-item, .fancybox-nav").remove(), r.wrap.stop(!0, !0).removeClass("fancybox-opened"), r.transitions[r.current.closeMethod]()) : (i(".fancybox-wrap").stop(!0).trigger("onReset").remove(), r._afterZoomOut())))
        },
        play: function(e) {
            var t = function() {
        ...
        reposition: function(e, t) {
            var n, o = r.current,
            s = o ? o.wrap: null;
            s && (n = r._getPosition(t), e && "scroll" === e.type ? (delete n.position, s.stop(!0, !0).animate(n, 200)) : (s.css(n), o.pos = i.extend({},
            o.dim, n)))
        },
        update: function(e) {
            var t = e && e.type,
            ...
            r.isOpen && !d && (d = setTimeout(function() {
                var n = r.current;
        ...
        getViewport: function() {
            ...
            return t ? (i.w = t[0].clientWidth, i.h = t[0].clientHeight) : (i.w = c && e.innerWidth ? e.innerWidth: s.width(), i.h = c && e.innerHeight ? e.innerHeight: s.height()),
            i
        },
        ...
        bindEvents: function() {
            var e, t = r.current;
            t && (s.bind("orientationchange.fb" + (c ? "": " resize.fb") + (t.autoCenter && !t.locked ? " scroll.fb": ""), r.update), (e = t.keys) && a.bind("keydown.fb",
            function(o) {
                var s = o.which || o.keyCode,
                a = o.target || o.srcElement;
                return 27 === s && r.coming ? !1 : void(!o.ctrlKey && !o.altKey && !o.shiftKey && !o.metaKey && (!a || !a.type && !i(a).is("[contenteditable]")) && i.each(e,
                function(e, a) {
            ...
            function(e, n, o, s) {
                for (var a = i(e.target || null), l = !1; a.length && !l && !a.is(".fancybox-skin") && !a.is(".fancybox-wrap");) l = a[0] && !(a[0].style.overflow && "hidden" === a[0].style.overflow) && (a[0].clientWidth && a[0].scrollWidth > a[0].clientWidth || a[0].clientHeight && a[0].scrollHeight > a[0].clientHeight),
                a = i(a).parent();
        ...
        trigger: function(e, t) {
            ...
            if (o) {
                ...
                o.helpers && i.each(o.helpers,
                function(t, n) {
                    n && r.helpers[t] && i.isFunction(r.helpers[t][e]) && r.helpers[t][e](i.extend(!0, {},
                    r.helpers[t].defaults, n), o)
                }),
                a.trigger(e)
            }
        },
        ...
        _start: function(e) {
            ...
            if (o = i.extend(!0, {},
            r.opts, t), t = o.margin, n = o.padding, "number" === i.type(t) && (o.margin = [t, t, t, t]), "number" === i.type(n) && (o.padding = [n, n, n, n]), o.modal && i.extend(!0, o, {
                closeBtn: !1,
                closeClick: !1,
                nextClick: !1,
                arrows: !1,
                ...
                if (n = o.type, t = o.href, !n) return r.coming = null,
                r.current && r.router && "jumpto" !== r.router ? (r.current.index = e, r[r.router](r.direction)) : !1;
        ...
        _preloadImages: function() {
            ...
            for (t = 1; s >= t; t += 1) e = i[(n.index + t) % o],
            "image" === e.type && e.href && ((new Image).src = e.href)
        },
        _afterLoad: function() {
            var e, t, n, o, s, a = r.coming,
            l = r.current;
            if (r.hideLoading(), a && !1 !== r.isActive) if (!1 === r.trigger("afterLoad", a, l)) a.wrap.stop(!0).trigger("onReset").remove(),
            r.coming = null;
            else {
                ...
                case "ajax":
                case "html":
                    a.selector ? e = i("<div>").html(e).find(a.selector) : u(e) && (e.data("fancybox-placeholder") || e.data("fancybox-placeholder", i('<div class="fancybox-placeholder"></div>').insertAfter(e).hide()), e = e.show().detach(), a.wrap.bind("onReset",
                    function() {
        ...
        _setDimension: function() {
            ...
            if (v = m(o), x = m(s), d = o / s, S = m(p(S) ? m(S, "w") - t: S), T = m(p(T) ? m(T, "w") - t: T), C = m(p(C) ? m(C, "h") - n: C), k = m(p(k) ? m(k, "h") - n: k), a = T, l = k, w.fitToView && (T = Math.min(u.w - t, T), k = Math.min(u.h - n, k)), t = u.w - I, M = u.h - M, w.aspectRatio ? (v > T && (v = T, x = m(v / d)), x > k && (x = k, v = m(x * d)), S > v && (v = S, x = m(v / d)), C > x && (x = C, v = m(x * d))) : (v = Math.max(S, Math.min(v, T)), w.autoHeight && "iframe" !== w.type && (b.width(v), x = b.height()), x = Math.max(C, Math.min(x, k))), w.fitToView) if (b.width(v).height(x), g.width(v + E), u = g.width(), I = g.height(), w.aspectRatio) for (; (u > t || I > M) && v > S && x > C && !(19 < h++);) x = Math.max(C, Math.min(k, x - 10)),
            v = m(x * d),
            S > v && (v = S, x = m(v / d)),
            v > T && (v = T, x = m(v / d)),
            b.width(v).height(x),
            ...
            u = g.width(),
            I = g.height();
            else v = Math.max(S, Math.min(v, v - (u - t))),
            x = Math.max(C, Math.min(x, x - (I - M)));
            _ && "auto" === j && s > x && t > v + E + _ && (v += _),
            b.width(v).height(x),
            g.width(v + E),
            u = g.width(),
            I = g.height(),
            g = (u > t || I > M) && v > S && x > C,
            v = w.aspectRatio ? a > v && l > x && o > v && s > x: (a > v || l > x) && (o > v || s > x),
            i.extend(w, {
                dim: {
                    width: f(u),
                    height: f(I)
        ...
        _getPosition: function(e) {
            ...
            return t.autoCenter && t.fixed && !e && s <= i.h && o <= i.w ? n.position = "fixed": t.locked || (n.top += i.y, n.left += i.x),
            n.top = f(Math.max(n.top, n.top + (i.h - s) * t.topRatio)),
            n.left = f(Math.max(n.left, n.left + (i.w - o) * t.leftRatio)),
            n
        },
        _afterZoomIn: function() {
            var e = r.current;
            e && (r.isOpen = r.isOpened = !0, r.wrap.css("overflow", "visible").addClass("fancybox-opened"), r.update(), (e.closeClick || e.nextClick && 1 < r.group.length) && r.inner.css("cursor", "pointer").bind("click.fb",
            function(t) { ! i(t.target).is("a") && !i(t.target).parent().is("a") && (t.preventDefault(), r[e.closeClick ? "close": "next"]())
    ...
    r.transitions = {
        getOrigPosition: function() {
            ...
            u(i) ? (n = i.offset(), i.is("img") && (o = i.outerWidth(), s = i.outerHeight())) : (n.top = d.y + (d.h - s) * e.topRatio, n.left = d.x + (d.w - o) * e.leftRatio),
            ("fixed" === r.wrap.css("position") || e.locked) && (n.top -= d.y, n.left -= d.x),
            n = {
        ...
        step: function(e, t) {
            ...
            n = r.current;
            var s = n.wrapSpace,
            a = n.skinSpace; ("width" === o || "height" === o) && (i = t.end === t.start ? 1 : (e - t.start) / (t.end - t.start), r.isClosing && (i = 1 - i), n = "width" === o ? n.wPadding: n.hPadding, n = e - n, r.skin[o](m("width" === o ? n: n - s * i)), r.inner[o](m("width" === o ? n: n - s * i - a * i)))
        },
        zoomIn: function() {
            var e = r.current,
            t = e.pos,
        ...
        changeIn: function() {
            ...
            s = r.direction;
            n.opacity = .1,
            "elastic" === i && (e = "down" === s || "up" === s ? "top": "left", "down" === s || "right" === s ? (n[e] = f(m(n[e]) - 200), o[e] = "+=200px") : (n[e] = f(m(n[e]) + 200), o[e] = "-=200px")),
            "none" === i ? r._afterZoomIn() : r.wrap.css(n).animate(o, {
    ...
    r.helpers.overlay = {
        ...
        beforeShow: function(e, t) {
            ...
            }).addClass("fancybox-margin"), this.el.addClass("fancybox-margin")), n = s.scrollTop(), o = s.scrollLeft(), this.el.addClass("fancybox-lock"), s.scrollTop(n).scrollLeft(o)),
            this.open(e)
        },
        onUpdate: function() {
        ...
        beforeShow: function(e) {
            ...
            if (i.isFunction(n) && (n = n.call(t.element, t)), h(n) && "" !== i.trim(n)) {
                ...
                default:
                    ...
                    r.current.margin[2] += Math.abs(m(t.css("margin-bottom")))
                }
    ...
    i.fn.fancybox = function(e) {
        ...
        s = function(s) {
            ...
            c = t; ! s.ctrlKey && !s.altKey && !s.shiftKey && !s.metaKey && !d.is(".fancybox-wrap") && (a = e.groupAttr || "data-fancybox-group", l = d.attr(a), l || (a = "rel", l = d.get(0)[a]), l && "" !== l && "nofollow" !== l && (d = o.length ? i(o) : n, d = d.filter("[" + a + '="' + l + '"]'), c = d.index(this)), e.index = c, !1 !== r.open(d, e) && s.preventDefault())
        };
        return e = e || {},
        t = e.index || 0,
        o && !1 !== e.live ? a.undelegate(o, "click.fb-start").delegate(o + ":not('.fancybox-item, .fancybox-nav')", "click.fb-start", s) : n.unbind("click.fb-start").bind("click.fb-start", s),
    ...
    t.helpers.media = {
        defaults: {
            ...
            metacafe: {
                ...
                type: "swf",
                url: function(t, i, n) {
                    return n.swf.flashVars = "playerVars=" + e.param(i, !0),
        ...
        beforeLoad: function(t, n) {
            ...
            for (o in t) if (t.hasOwnProperty(o) && (s = t[o], a = l.match(s.matcher))) {
                d = s.type,
                r = e.extend(!0, {},
                s.params, n[o] || (e.isPlainObject(t[o]) ? t[o].params: null)),
                l = "function" === e.type(s.url) ? s.url.call(this, a, r, n) : i(s.url, a, r);
                break
            }
...
function(e, t, i) {
    var n = {
        init: function(t, i) {
            ...
            e.fn.owlCarousel.options, this.$elem.data(), t),
            this.userOptions = t,
            this.loadContent()
        },
        loadContent: function() {
            ...
            "string" == typeof n.options.jsonPath ? (i = n.options.jsonPath, e.getJSON(i, t)) : n.logIn()
        },
        logIn: function() {
        ...
        updateItems: function() {
            ...
            else t <= this.options.itemsDesktop[0] && !1 !== this.options.itemsDesktop && (this.options.items = this.options.itemsDesktop[1]),
        ...
        appendItemsSizes: function() {
            ...
            t.$owlItems.each(function(o) {
                ...
                (0 === o % t.options.items || o === n) && (o > n || (i += 1)),
        ...
        max: function() {
            ...
            return this.options.items > this.itemsAmount ? this.maximumPixels = e = this.maximumItem = 0 : (this.maximumItem = this.itemsAmount - this.options.items, this.maximumPixels = e),
            e
        },
        min: function() {
            return 0
        ...
        loops: function() {
            var t, i, n = 0,
            o = 0;
            for (this.positionsInArray = [0], this.pagesInArray = [], t = 0; t < this.itemsAmount; t += 1) o += this.itemWidth,
            this.positionsInArray.push( - o),
            !0 === this.options.scrollPerPage && (i = e(this.$owlItems[t]), i = i.data("owl-roundPages"), i !== n && (this.pagesInArray[n] = this.positionsInArray[t], n = i))
        },
        buildControls: function() { (!0 === this.options.navigation || !0 === this.options.pagination) && (this.owlControls = e('<div class="owl-controls"/>').toggleClass("clickable", !this.browser.isTouch).appendTo(this.$elem)),
        ...
        buildButtons: function() {
            ...
            i.on("touchstart.owlControls mousedown.owlControls", 'div[class^="owl"]',
            function(e) {
                e.preventDefault()
            }),
            i.on("touchend.owlControls mouseup.owlControls", 'div[class^="owl"]',
            function(i) {
                i.preventDefault(),
        ...
        buildPagination: function() {
            ...
            t.paginationWrapper.on("touchend.owlControls mouseup.owlControls", ".owl-page",
            function(i) {
                i.preventDefault(),
        ...
        play: function() {
            ...
            !1 === e.options.autoPlay ? !1 : (t.clearInterval(e.autoPlayInterval), void(e.autoPlayInterval = t.setInterval(function() {
                e.next(!0)
            },
            e.options.autoPlay)))
        },
        ...
        gestures: function() {
            ...
            function s(o) {
                ...
                r.newPosX = n(o).x - l.offsetX,
                r.newPosY = n(o).y - l.offsetY,
                r.newRelativeX = r.newPosX - l.relativePos,
                "function" == typeof r.options.startDragging && !0 !== l.dragging && 0 !== r.newRelativeX && (l.dragging = !0, r.options.startDragging.apply(r, [r.$elem])),
                (8 < r.newRelativeX || -8 > r.newRelativeX) && !0 === r.browser.isTouch && (void 0 !== o.preventDefault ? o.preventDefault() : o.returnValue = !1, l.sliding = !0),
                (10 < r.newPosY || -10 > r.newPosY) && !1 === l.sliding && e(i).off("touchmove.owl"),
            ...
            function a(i) {
                ...
                0 !== r.newRelativeX && (n = r.getNewPosition(), r.goTo(n, !1, "drag"), l.targetElement === i.target && !0 !== r.browser.isTouch && (e(i.target).on("click.disable",
                function(t) {
                    t.stopImmediatePropagation(),
                    t.stopPropagation(),
                    t.preventDefault(),
                    e(t.target).off("click.disable")
                }), i = e._data(i.target, "events").click, n = i.pop(), i.splice(0, 0, n))),
                o("off")
            }
            var r = this,
            l = {
            ...
            r.isCssFinish = !0,
            r.$elem.on(r.ev_types.start, ".owl-wrapper",
            function(i) {
                i = i.originalEvent || i || t.event;
                var s;
                if (3 === i.which) return ! 1;
                if (! (r.itemsAmount <= r.options.items)) {
                    if (!1 === r.isCssFinish && !r.options.dragBeforeAnimFinish || !1 === r.isCss3Finish && !r.options.dragBeforeAnimFinish) return ! 1; ! 1 !== r.options.autoPlay && t.clearInterval(r.autoPlayInterval),
        ...
        getNewPosition: function() {
            ...
            return e > this.maximumItem ? e = this.currentItem = this.maximumItem: 0 <= this.newPosX && (this.currentItem = e = 0),
            e
        },
        ...
        moveDirection: function() {
            var e;
            return 0 > this.newRelativeX ? (e = "right", this.playDirection = "next") : (e = "left", this.playDirection = "prev"),
            e
        },
        customEvents: function() {
            ...
            e.$elem.on("owl.jumpTo",
            function(t, i) {
                e.jumpTo(i)
            })
        },
        stopOnHover: function() {
            var e = this; ! 0 === e.options.stopOnHover && !0 !== e.browser.isTouch && !1 !== e.options.autoPlay && (e.$elem.on("mouseover",
            function() {
                e.stop()
            }), e.$elem.on("mouseout",
            function() {
        ...
        lazyLoad: function() {
            ...
            for (t = 0; t < this.itemsAmount; t += 1) i = e(this.$owlItems[t]),
        ...
        lazyPreload: function(e, i) {
            ...
            function o() {
                r += 1,
                a.completeImg(i.get(0)) || !0 === s ? n() : 100 >= r ? t.setTimeout(o, 100) : n()
            }
            var s, a = this,
            r = 0;
        ...
        autoHeight: function() {
            function i() {
                ...
                s.wrapperOuter.hasClass("autoHeight") || t.setTimeout(function() {
            ...
            function n() {
                o += 1,
                s.completeImg(a.get(0)) ? i() : 100 >= o ? t.setTimeout(n, 100) : s.wrapperOuter.css("height", "")
            }
            var o, s = this,
        ...
        onVisibleItems: function() {
            var t;
            for (!0 === this.options.addClassActive && this.$owlItems.removeClass("active"), this.visibleItems = [], t = this.currentItem; t < this.currentItem + this.options.items; t += 1) this.visibleItems.push(t),
            !0 === this.options.addClassActive && e(this.$owlItems[t]).addClass("active");
        ...
        singleItemTransition: function() {
            ...
            o.css({
                position: "relative",
                left: s + "px"
            }).addClass(t).on("webkitAnimationEnd oAnimationEnd MSAnimationEnd animationend",
            function() {
                e.endPrev = !0,
                o.off("webkitAnimationEnd oAnimationEnd MSAnimationEnd animationend"),
                e.clearTransStyle(o, t)
            }),
            n.addClass(i).on("webkitAnimationEnd oAnimationEnd MSAnimationEnd animationend",
            function() {
                e.endCurrent = !0,
...
function(e) {
    ...
    e(function() {
        ...
        e(".op-theme-colors button").click(function() {
            e(".op-theme-colors button").removeClass("active"),
            e(this).addClass("active"),
            t("theme-color", "theme-color-" + e(this).data("color"))
        }),
        e(".op-theme-skin button").click(function() {
            i(e(this)),
            t("theme-skin", "theme-skin-" + e(this).data("value"))
        }),
        e("body").hasClass("header-has-img") ? e(".op-btn-check").addClass("active") : e(".op-btn-check").removeClass("active"),
        e(".op-theme-headimg button").click(function() {
...
function(e) {
    ...
    function l() {
        e(window).width() > 600 ? e(".timeline").each(function() {
            ...
            a = 0,
            r = 0,
            l = e(this).find(".timeline-bar"), d = e(this).find(".timeline-inner"), c = e(this).find(".timeline-box-left"), u = e(this).find(".timeline-box-right"), h = 0; h < c.length; h++) e(c[h]).css({
                position: "absolute",
                left: "0",
                top: i + "px"
            }),
    ...
    function c() {
        ...
        t.length > 0 && (z = {
            ...
            initToday: function() {
                o.html(this.currentDay),
                s.html(this.monthNames[this.currentMonth].substring(0, 3)),
                a.html(this.weekNames[this.currentWeekDay])
            },
            initWeekNames: function() {
                "monday" == z.weekStart && (z.weekNames = ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"]);
                for (var e = "<tr>",
                t = 0; t < this.weekNames.length; ++t) e += "<th>" + this.weekNames[t].substring(0, 3) + "</th>";
                e += "</tr>",
                i.append(e)
            },
            ...
            createMonthHtml: function(e, t) {
                ...
                s = [];
                "monday" == z.weekStart && (0 == o ? o = 6 : o -= 1),
                r.empty().html(this.monthNames[t]),
                l.empty().html(e);
                ...
                for (var d = 0; 42 > d; d++) {
                    var c = "";
                    e == this.currentYear && t == this.currentMonth && d - o + 1 == this.currentDay && (c += "current-day"),
                    j(s, d - o + 1) && (c += " busy-day"),
                    d % 7 == 0 && (i += "<tr>"),
                    i += o > d || d >= o + this.getDaysInMonth(e, t) ? '<td class="calendar-other-month"><span></span></td>': '<td class="calendar-current-month"><span class="' + c + '">' + (d - o + 1) + "</span></td>",
                    d % 7 == 6 && (i += "</tr>")
                }
                n.empty().append(i)
            },
            nextMonth: function() {
                this.active.year != this.limitUp.year || this.active.month != this.limitUp.month ? (d.addClass("moveup"), n.addClass("moveright"), setTimeout(function() {
                    d.removeClass("moveup"),
                    d.addClass("movedown"),
                    n.removeClass("moveright"),
                    n.addClass("moveleft")
                },
                300), setTimeout(function() {
                    d.removeClass("movedown"),
                    n.removeClass("moveleft")
                },
        ...
        z.active.year = z.currentYear, z.active.month = z.currentMonth, z.limitUp.year = z.currentYear + 1, z.limitUp.month = z.currentMonth, z.limitDown.year = z.currentYear, z.limitDown.month = z.currentMonth, z.weekStart = t.data("weekstart"), z.busyDays = B, z.init(), t.on(A, ".calendar-prev",
        function() {
            z.prevMonth()
        }), t.on(A, ".calendar-next",
        function() {
            z.nextMonth()
        }))
    }
    ...
    function b() {
        ...
        o.data("latitude") && (i = o.data("latitude")),
    ...
    function w() {
        ...
        t.data("scroll-position", s),
        t.data("previous-overflow", t.css("overflow")),
    ...
    function S() {
        e("body").addClass("mobile-nav-opened"),
        w()
    }
    function C() {
        e("body").removeClass("mobile-nav-opened"),
        x()
    }
    function T() {
        e("body").addClass("sidebar-opened"),
        w()
    }
    function k() {
        e("body").removeClass("sidebar-opened"),
        x()
    }
    function j(e, t) {
    ...
    R = 0,
    H = 0;
    /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) ? (L = !0, e("html").addClass("mobile")) : (L = !1, e("html").addClass("desktop")),
    ...
    e(window).load(function() {
        ...
        e(document).on(A, ".ripple",
        function(t) {
            I(e(this), t.pageX, t.pageY)
        }),
        e(document).on(A, ".ripple-centered",
        function() {
            ...
            e(".portfolioFancybox").fancybox({
                ...
                beforeShow: function() {
                    ...
                    if (n.length > 0) {
                        ...
                        case "image":
                            n.empty(),
                            n.addClass("inline-embed-image"),
                            n.append('<img src="' + s + '" />');
                            break;
                        case "iframe":
                            n.empty(),
                            n.addClass("inline-embed-iframe"),
                            n.append('<iframe src="' + s + '" allowfullscreen></iframe>');
                            break;
                        case "video":
                            Y = "",
                            n.addClass("inline-embed-video");
        ...
        e(".nav-wrap .nav").length > 0 && e(".nav-wrap .nav > ul > li > a").append("<span></span>"),
        P = e(".head-bar"),
        P.length > 0 && (P.addClass("animated"), g(), e(window).scroll(function() {
            g()
        })),
        g(),
        e("#mobile-nav>ul").onePageNav({
            currentClass: "active",
            changeHash: !0,
            scrollSpeed: 500,
            scrollThreshold: .5,
        ...
        e(document).on(A, "#overlay",
        function() {
            e("body").hasClass("mobile-nav-opened") && C(),
            e("body").hasClass("sidebar-opened") && k()
        }),
        e("#map").length > 0 && b();
        var X = e(".blog-grid");
        if (X.length > 0) {
        ...
        function(t) {
            ...
            return o.removeClass("error"),
            i = !1,
            "" === s.val() && (i = !0, s.parent().addClass("error")),
            "" !== a.val() && _(a.val()) || (i = !0, a.parent().addClass("error")),
            "" === r.val() && (i = !0, r.parent().addClass("error")),
            i || e.post("php/contact_form.php", n.serialize(),
            function(e) {
                l.html(e)
            }),
            !1
    ...
    e(window).resize(function() {
        ...
        i = e(window).width(),
        n = e(window).height(); ($ != i || V != n) && (window.clearTimeout(N), N = window.setTimeout(t, 10)),
        $ = i,
        V = n
    })
} (jQuery);